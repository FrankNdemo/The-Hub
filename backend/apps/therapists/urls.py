...
urlpatterns = [
    ...
    path("auth/password-reset/request/", PasswordResetRequestView.as_view(), name="therapist-password-reset-request"),
    path("auth/password-reset/validate/", PasswordResetValidateView.as_view(), name="therapist-password-reset-validate"),
    path("auth/password-reset/confirm/", PasswordResetConfirmView.as_view(), name="therapist-password-reset-confirm"),
