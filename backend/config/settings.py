...
SECURE_HSTS_SECONDS = int(env("DJANGO_SECURE_HSTS_SECONDS", "0" if DEBUG else "31536000") or "0")
...
CONTACT_INQUIRY_RECIPIENT_EMAIL = env("CONTACT_INQUIRY_RECIPIENT_EMAIL", "cgichia@gmail.com")
THERAPIST_BOOTSTRAP_SECRET_PASSPHRASE = env("THERAPIST_BOOTSTRAP_SECRET_PASSPHRASE", "")
...
VIRTUAL_SESSION_ROOM_PREFIX = env("VIRTUAL_SESSION_ROOM_PREFIX", "the-wellness-hub")
...
PASSWORD_RESET_TIMEOUT = int(env("PASSWORD_RESET_TIMEOUT", "3600") or "3600")
WHATSAPP_CLOUD_API_TOKEN = env("WHATSAPP_CLOUD_API_TOKEN", "")
WHATSAPP_CLOUD_PHONE_NUMBER_ID = env("WHATSAPP_CLOUD_PHONE_NUMBER_ID", "")
WHATSAPP_CLOUD_API_URL = env("WHATSAPP_CLOUD_API_URL", "https://graph.facebook.com/v19.0").rstrip("/")
WHATSAPP_INQUIRY_RECIPIENT = env("WHATSAPP_INQUIRY_RECIPIENT", "")
WHATSAPP_API_TIMEOUT = int(env("WHATSAPP_API_TIMEOUT", "5") or "5")
...
MPESA_TIMEOUT_SECONDS = int(env("MPESA_TIMEOUT_SECONDS", "10") or "10")
MPESA_STATUS_TIMEOUT_SECONDS = int(env("MPESA_STATUS_TIMEOUT_SECONDS", str(min(MPESA_TIMEOUT_SECONDS, 8))) or "8")
